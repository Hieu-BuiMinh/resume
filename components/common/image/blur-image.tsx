...
const BlurImage = forwardRef<HTMLImageElement, ImageProps>((props, ref) => {
	...
	return (
		...
		>
			...
			{rest?.description && (
				<div className="pointer-events-none absolute inset-0 flex flex-col items-start justify-end bg-gradient-to-b from-transparent to-black p-3 text-xs text-white font-semibold italic opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100">
